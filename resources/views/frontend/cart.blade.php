        ...
        <div class="card-body px-1 px-md-5 pt-5">
          <table class="table table-borderless table-cart" data-addclass-on-smdown="table-sm">
            <tbody>
              ...
              <tr>
                <td class="cart-img nostretch">
                  <a href="shop-single.html"><img src="../img/products/2_small.jpg" alt="The Flash Logo T-Shirt"></a>
                </td>
                <td class="cart-title">
                  <a href="shop-single.html" class="h6 bold d-inline-block" title="The Flash Logo T-Shirt">The Flash Logo T-Shirt</a>
                  <div><i data-feather="check-circle" class="text-success"></i> In Stock</div>
                  
                  <small class="ml-3"><b>Size</b>: medium</small>
                  
                  <small class="ml-3"><b>Color</b>: yellow</small>
                ...
                <td class="cart-price text-right">
                  <span class="roboto-condensed bold">$16.64</span>
                </td>
                <td class="cart-action nostretch pr-0">
                  <div class="dropdown">
                    <a href="#" class="nav-icon text-secondary dropdown-toggle" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
              ...
              <tr>
                <td class="cart-img nostretch">
                  <a href="shop-single.html"><img src="../img/products/3_small.jpg" alt="Open Front Cropped Cardigans"></a>
                </td>
                <td class="cart-title">
                  <a href="shop-single.html" class="h6 bold d-inline-block" title="Open Front Cropped Cardigans">Open Front Cropped Cardigans</a>
                  <div><i data-feather="x-circle" class="text-danger"></i> Out of Stock</div>
                  
                  <small class="ml-3"><b>Size</b>: large</small>
                ...
                <td class="cart-price text-right">
                  <span class="roboto-condensed bold">$15.20</span>
                </td>
                <td class="cart-action nostretch pr-0">
                  <div class="dropdown">
                    <a href="#" class="nav-icon text-secondary dropdown-toggle" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
              ...
              <tr>
                <td class="cart-img nostretch">
                  <a href="shop-single.html"><img src="../img/products/4_small.jpg" alt="Cotton Fleece Long Hoodie"></a>
                </td>
                <td class="cart-title">
                  <a href="shop-single.html" class="h6 bold d-inline-block" title="Cotton Fleece Long Hoodie">Cotton Fleece Long Hoodie</a>
                  <div><i data-feather="check-circle" class="text-success"></i> In Stock</div>
                  
                  <small class="ml-3"><b>Size</b>: small</small>
                  
                  <small class="ml-3"><b>Color</b>: olive green</small>
                ...
                <td class="cart-price text-right">
                  <span class="roboto-condensed bold">$85.00</span>
                </td>
                <td class="cart-action nostretch pr-0">
                  <div class="dropdown">
                    <a href="#" class="nav-icon text-secondary dropdown-toggle" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
          ...
          <div class="text-center">
            ...
            <a href="shipping.html" class="btn btn-primary rounded-pill btn-lg">Shipping <i data-feather="arrow-right"></i></a>
          </div>
        </div>
      </div>
    </div>
