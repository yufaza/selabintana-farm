<header>
    <div class="container">
      ...
      <!-- Logo -->
      <a class="nav-link nav-logo" href="index.html"><img src="https://mimity-fashion53.netlify.com/img/logo.svg" alt="Mimity"> <strong>Mimity</strong></a>
            ...
            <div class="row">
              ...
              <div class="col-lg-3 border-left roboto-condensed">
                <div class="card text-white zoom-hover">
                  <div data-cover="https://mimity-fashion53.netlify.com/img/categories/1.jpeg" data-height="260px"></div>
              ...
              <div class="col-lg-3 border-left roboto-condensed">
                <div class="card text-white zoom-hover">
                  <div data-cover="https://mimity-fashion53.netlify.com/img/categories/6.jpeg" data-height="260px"></div>
                  <div class="card-img-overlay card-img-overlay-transparent d-flex justify-content-center align-items-center flex-column">
      ...
      <ul class="nav ml-auto ml-sm-0">
        ...
        <li class="nav-item dropdown dropdown-hover dropdown-cart">
          ...
          <div class="dropdown-menu dropdown-menu-right">
                          <div class="media">
              <a href="shop-single.html"><img src="https://mimity-fashion53.netlify.com/img/products/1_small.jpg" width="50" height="50" alt="Hanes Hooded Sweatshirt"></a>
              <div class="media-body">
                ...
                <button type="button" class="close" aria-label="Close"><i data-feather="x-circle"></i></button>
                          ...
                          <div class="media">
              <a href="shop-single.html"><img src="https://mimity-fashion53.netlify.com/img/products/2_small.jpg" width="50" height="50" alt="The Flash Logo T-Shirt"></a>
              <div class="media-body">
                ...
                <button type="button" class="close" aria-label="Close"><i data-feather="x-circle"></i></button>
                          ...
                          <div class="media">
              <a href="shop-single.html"><img src="https://mimity-fashion53.netlify.com/img/products/3_small.jpg" width="50" height="50" alt="Open Front Cropped Cardigans"></a>
              <div class="media-body">
                ...
                <button type="button" class="close" aria-label="Close"><i data-feather="x-circle"></i></button>
                          ...
                          <div class="media">
              <a href="shop-single.html"><img src="https://mimity-fashion53.netlify.com/img/products/4_small.jpg" width="50" height="50" alt="Cotton Fleece Long Hoodie"></a>
              <div class="media-body">
